...
class ContentService:
  ...
  """
  def process_content_video(self, video_url:str, user_type:UserType, user_id:int=0) -> VideoContent:
    all_results = []
    ...
    all_ias = factory_user_content.create_all_ias()
    content_repository = factory_user_content.create_content_repository()
    notifier = factory_user_content.create_notifier()
    workflow = factory_user_content.create_workflow()
