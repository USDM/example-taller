...
from ..validate_total_messages.validate_total_messages_repo import ValidateTotalMessages
from ..get_prompt.factory_get_prompt import FactoryGetPrompt
...
def create_chat_ia_use_case():
    ...
    validate_total_messages_repo = ValidateTotalMessages()
    get_prompt_factory = FactoryGetPrompt()
    return ChatIAUseCase(search_content_repository, ia, memory_save, validate_total_messages_repo, get_prompt_factory)